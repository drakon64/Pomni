...
namespace Pomni.Client.GitHub.Repos.Item.Item
{
    ...
    internal partial class WithRepoPatchRequestBody : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_title? MergeCommitTitle { get; set; }
...
#nullable restore
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_pull_request_creation_policy? PullRequestCreationPolicy { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_security_and_analysis? SecurityAndAnalysis { get; set; }
#nullable restore
#else
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_security_and_analysis SecurityAndAnalysis { get; set; }
#endif
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        public global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_visibility? Visibility { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_message>(); } },
                { "merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_title>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "private", n => { Private = n.GetBoolValue(); } },
                { "pull_request_creation_policy", n => { PullRequestCreationPolicy = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_pull_request_creation_policy>(); } },
                { "security_and_analysis", n => { SecurityAndAnalysis = n.GetObjectValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_security_and_analysis>(global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_security_and_analysis.CreateFromDiscriminatorValue); } },
                { "squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_message>(); } },
                { "squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_title>(); } },
                { "use_squash_pr_title_as_default", n => { UseSquashPrTitleAsDefault = n.GetBoolValue(); } },
                { "visibility", n => { Visibility = n.GetEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_visibility>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_pull_request_creation_policy>("pull_request_creation_policy", PullRequestCreationPolicy);
            writer.WriteObjectValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_security_and_analysis>("security_and_analysis", SecurityAndAnalysis);
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            writer.WriteBoolValue("use_squash_pr_title_as_default", UseSquashPrTitleAsDefault);
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Repos.Item.Item.WithRepoPatchRequestBody_visibility>("visibility", Visibility);
