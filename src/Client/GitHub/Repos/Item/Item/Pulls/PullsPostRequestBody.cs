...
namespace Pomni.Client.GitHub.Repos.Item.Item.Pulls
{
    ...
    internal partial class PullsPostRequestBody : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Pomni.Client.GitHub.Repos.Item.Item.Pulls.PullsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Pomni.Client.GitHub.Repos.Item.Item.Pulls.PullsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Pomni.Client.GitHub.Repos.Item.Item.Pulls.PullsPostRequestBody();
        }
        /// <summary>
