...
#nullable enable
        public List<global::Pomni.Client.GitHub.Models.ReleaseAsset>? Assets { get; set; }
#nullable restore
#else
        public List<global::Pomni.Client.GitHub.Models.ReleaseAsset> Assets { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Pomni.Client.GitHub.Models.SimpleUser? Author { get; set; }
#nullable restore
#else
        public global::Pomni.Client.GitHub.Models.SimpleUser Author { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Pomni.Client.GitHub.Models.ReactionRollup? Reactions { get; set; }
#nullable restore
#else
        public global::Pomni.Client.GitHub.Models.ReactionRollup Reactions { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Pomni.Client.GitHub.Models.Release CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Pomni.Client.GitHub.Models.Release();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assets", n => { Assets = n.GetCollectionOfObjectValues<global::Pomni.Client.GitHub.Models.ReleaseAsset>(global::Pomni.Client.GitHub.Models.ReleaseAsset.CreateFromDiscriminatorValue)?.AsList(); } },
                { "assets_url", n => { AssetsUrl = n.GetStringValue(); } },
                { "author", n => { Author = n.GetObjectValue<global::Pomni.Client.GitHub.Models.SimpleUser>(global::Pomni.Client.GitHub.Models.SimpleUser.CreateFromDiscriminatorValue); } },
                ...
                { "reactions", n => { Reactions = n.GetObjectValue<global::Pomni.Client.GitHub.Models.ReactionRollup>(global::Pomni.Client.GitHub.Models.ReactionRollup.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Pomni.Client.GitHub.Models.ReleaseAsset>("assets", Assets);
            writer.WriteStringValue("assets_url", AssetsUrl);
            writer.WriteObjectValue<global::Pomni.Client.GitHub.Models.SimpleUser>("author", Author);
            ...
            writer.WriteObjectValue<global::Pomni.Client.GitHub.Models.ReactionRollup>("reactions", Reactions);
