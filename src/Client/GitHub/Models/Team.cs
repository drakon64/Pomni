...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Pomni.Client.GitHub.Models.NullableTeamSimple? Parent { get; set; }
#nullable restore
#else
        public global::Pomni.Client.GitHub.Models.NullableTeamSimple Parent { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Pomni.Client.GitHub.Models.Team_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::Pomni.Client.GitHub.Models.Team_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::Pomni.Client.GitHub.Models.Team_type? Type { get; set; }
...
#nullable restore
        ...
        public static global::Pomni.Client.GitHub.Models.Team CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Pomni.Client.GitHub.Models.Team();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access_source", n => { AccessSource = n.GetEnumValue<global::Pomni.Client.GitHub.Models.Team_access_source>(); } },
                ...
                { "parent", n => { Parent = n.GetObjectValue<global::Pomni.Client.GitHub.Models.NullableTeamSimple>(global::Pomni.Client.GitHub.Models.NullableTeamSimple.CreateFromDiscriminatorValue); } },
                { "permission", n => { Permission = n.GetStringValue(); } },
                { "permissions", n => { Permissions = n.GetObjectValue<global::Pomni.Client.GitHub.Models.Team_permissions>(global::Pomni.Client.GitHub.Models.Team_permissions.CreateFromDiscriminatorValue); } },
                { "privacy", n => { Privacy = n.GetStringValue(); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "slug", n => { Slug = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Pomni.Client.GitHub.Models.Team_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Pomni.Client.GitHub.Models.Team_access_source>("access_source", AccessSource);
            ...
            writer.WriteObjectValue<global::Pomni.Client.GitHub.Models.NullableTeamSimple>("parent", Parent);
            writer.WriteStringValue("permission", Permission);
            writer.WriteObjectValue<global::Pomni.Client.GitHub.Models.Team_permissions>("permissions", Permissions);
