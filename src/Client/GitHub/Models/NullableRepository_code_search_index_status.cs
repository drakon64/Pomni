...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Pomni.Client.GitHub.Models.NullableRepository_code_search_index_status"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Pomni.Client.GitHub.Models.NullableRepository_code_search_index_status CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Pomni.Client.GitHub.Models.NullableRepository_code_search_index_status();
        }
        /// <summary>
