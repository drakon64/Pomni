...
var forgeArgument = new Argument<Forge>("forge") { Description = "The Git forge of the pin" };
...
var forgeOption = new Option<Forge>("-f", "--forge") { Description = "The Git forge of the pin" };
...
botCommand.SetAction(parseResult => Bot.BotCommand(parseResult.GetRequiredValue(botForgeArgument)));
